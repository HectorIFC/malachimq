defmodule MalachiMQ.IntegrationTest do
  ...
  describe "end-to-end message flow" do
    test "producer -> queue -> consumer flow" do
      queue_name = "integration_test_#{:rand.uniform(100000)}"
      test_pid = self()
    ...
    test "buffered messages are delivered to new consumer" do
      queue_name = "buffer_integration_#{:rand.uniform(100000)}"
    ...
    test "multiple consumers share workload" do
      queue_name = "multi_consumer_#{:rand.uniform(100000)}"
      test_pid = self()
      ...
      consumers_that_worked = for _ <- 1..6 do
        receive do
    ...
    test "metrics are tracked correctly" do
      queue_name = "metrics_integration_#{:rand.uniform(100000)}"
    ...
    test "auth -> publish -> consume flow" do
      queue_name = "auth_integration_#{:rand.uniform(100000)}"
  ...
  describe "error handling" do
    test "consumer handles callback errors gracefully" do
      queue_name = "error_test_#{:rand.uniform(100000)}"
      test_pid = self()
    ...
    test "queue survives consumer crashes" do
      queue_name = "crash_test_#{:rand.uniform(100000)}"
