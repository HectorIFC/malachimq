defmodule MalachiMQ.AckManagerTest do
  ...
  setup do
    queue_name = "ack_test_#{:rand.uniform(100000)}"
    message_id = :erlang.unique_integer([:monotonic, :positive])
    consumer_pid = spawn(fn -> receive do _ -> :ok end end)
  ...
  describe "track_message/4" do
    test "tracks a new message", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
    ...
    test "tracks multiple messages", %{queue_name: queue_name} do
      for i <- 1..5 do
        ...
        msg = %{id: msg_id, payload: "test#{i}", headers: %{}, timestamp: System.system_time(:microsecond), queue: queue_name}
  ...
  describe "ack/1" do
    test "acknowledges a message", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
    ...
    test "increments acked metric", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
      MalachiMQ.AckManager.track_message(message_id, queue_name, consumer_pid, message)
  ...
  describe "nack/2" do
    test "nacks a message without requeue", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
      MalachiMQ.AckManager.track_message(message_id, queue_name, consumer_pid, message)
    ...
    test "nacks and requeues message", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
      MalachiMQ.AckManager.track_message(message_id, queue_name, consumer_pid, message)
    ...
    test "increments nacked metric", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
      MalachiMQ.AckManager.track_message(message_id, queue_name, consumer_pid, message)
  ...
  describe "get_status/1" do
    test "returns pending status", %{queue_name: queue_name, message_id: message_id, consumer_pid: consumer_pid, message: message} do
      MalachiMQ.AckManager.track_message(message_id, queue_name, consumer_pid, message)
